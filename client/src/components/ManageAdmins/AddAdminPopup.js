...
import * as StyledPopup from '../../Styles/ManageAdmins/ManageAdminsAdd.styled';
import { GrFormClose } from 'react-icons/gr';

import useLoading from '../../hooks/useLoading';


const AddHodPopup = ({ setIsAddPopupShowing, fetchAdmins }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${process.env.REACT_APP_BACKEND_SERV}/api/register`, { email, name, password, role: 'Admin' });
